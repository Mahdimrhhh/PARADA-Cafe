...
//#region node_modules/.nitro/vite/services/ssr/assets/format-DqAqKtxT.js
var import_jsx_runtime = require_jsx_runtime();
function cn(...inputs) {
	return twMerge(clsx(inputs));
}
function svgProps({ className, ...props }) {
	return {
		viewBox: "0 0 32 32",
		fill: "none",
...
function CupIcon(props) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
				d: "M21 13.5h3.4A2.4 2.4 0 0 1 24.4 18H21",
				stroke: "currentColor",
				strokeWidth: "1.8"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 font-medium transition-[transform,opacity,background-color,color,box-shadow] duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber/70 focus-visible:ring-offset-2 focus-visible:ring-offset-plaster disabled:pointer-events-none disabled:opacity-40 active:not-disabled:scale-[0.96]", {
	variants: {
		variant: {
			...
			ghost: "bg-transparent text-ink hover:bg-plaster-deep",
			outline: "bg-cream/70 text-ink shadow-[var(--shadow-border)] hover:bg-cream",
...
function formatToman(amount) {
	return toFaDigits(Math.round(amount).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")).replace(/,/g, "٬");
}
//#endregion
export { formatToman as a, cn as i, CategoryIcon as n, ICON_KEYS as r, Button as t };
