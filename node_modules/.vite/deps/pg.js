...
import { t as require_browser_external_path } from "./browser-external_path-D3EqcgGv.js";
import { t as require_browser_external_fs } from "./browser-external_fs-Dk1dP2xu.js";
import { t as require_browser_external_crypto } from "./browser-external_crypto-CtLKaFMs.js";
import { t as require_browser_external_util } from "./browser-external_util-DdRo-3Ku.js";
import { t as require_browser_external_stream } from "./browser-external_stream-CwWDFrBs.js";
//#region browser-external:events
var require_browser_external_events = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "events" has been externalized for browser compatibility. Cannot access "events.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
...
//#endregion
//#region browser-external:util/types
var require_types = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "util/types" has been externalized for browser compatibility. Cannot access "util/types.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
...
var require_query$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { EventEmitter } = require_browser_external_events();
...
var require_connection = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var EventEmitter = require_browser_external_events().EventEmitter;
...
var require_split2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var { StringDecoder } = require_browser_external_string_decoder();
...
var require_helper = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var Stream = require_browser_external_stream().Stream;
...
var require_client$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var EventEmitter = require_browser_external_events().EventEmitter;
	var utils = require_utils$1();
	var nodeUtils = require_browser_external_util();
