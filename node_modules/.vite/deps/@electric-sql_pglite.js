...
import { _ as T$1, a as Re$2, b as u, c as Ye$2, d as wt$2, f as p$1, g as R$1, h as P$2, i as I$1, l as at$2, m as L$1, n as B$1, p as F$1, r as Gr, t as At$1, u as jr, v as U$1, x as x$2, y as h } from "./chunk-DDJLRBDX-CSww6dWM.js";
...
var T = class {
	constructor(t = 256) {
		...
		R$1(this, O$1, 0);
		x$2(this, b, T$1(this, S, ie$1).call(this, t));
	}
	addInt32(t) {
		return T$1(this, S, L).call(this, 4), h(this, b).setInt32(h(this, g$1), t, h(this, k)), x$2(this, g$1, h(this, g$1) + 4), this;
	}
	addInt16(t) {
		return T$1(this, S, L).call(this, 2), h(this, b).setInt16(h(this, g$1), t, h(this, k)), x$2(this, g$1, h(this, g$1) + 2), this;
	}
	addCString(t) {
		return t && this.addString(t), T$1(this, S, L).call(this, 1), h(this, b).setUint8(h(this, g$1), 0), U$1(this, g$1)._++, this;
	}
	addString(t = "") {
		let n = P$1(t);
		return T$1(this, S, L).call(this, n), h(this, ae$1).encodeInto(t, new Uint8Array(h(this, b).buffer, h(this, g$1))), x$2(this, g$1, h(this, g$1) + n), this;
	}
	add(t) {
		return T$1(this, S, L).call(this, t.byteLength), new Uint8Array(h(this, b).buffer).set(new Uint8Array(t), h(this, g$1)), x$2(this, g$1, h(this, g$1) + t.byteLength), this;
	}
	flush(t) {
		let n = T$1(this, S, Je$1).call(this, t);
		return x$2(this, g$1, 5), x$2(this, b, T$1(this, S, ie$1).call(this, this.size)), new Uint8Array(n);
	}
};
b = /* @__PURE__ */ new WeakMap(), g$1 = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), ae$1 = /* @__PURE__ */ new WeakMap(), O$1 = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakSet(), ie$1 = function(t) {
	...
	if (h(this, b).byteLength - h(this, g$1) < t) {
		let s = h(this, b).buffer, i = s.byteLength + (s.byteLength >> 1) + t;
		x$2(this, b, T$1(this, S, ie$1).call(this, i)), new Uint8Array(h(this, b).buffer).set(new Uint8Array(s));
	}
}, Je$1 = function(t) {
	if (t) {
		h(this, b).setUint8(h(this, O$1), t);
		let n = h(this, g$1) - (h(this, O$1) + 1);
		h(this, b).setInt32(h(this, O$1) + 1, n, h(this, k));
	}
...
var ue$1 = class {
	constructor(t = 0) {
		...
		R$1(this, w);
		R$1(this, ce$1, "utf-8");
		R$1(this, le$1, new TextDecoder(h(this, ce$1)));
		R$1(this, te, !1);
		x$2(this, w, t);
	}
	setBuffer(t, n) {
	...
	int16() {
		let t = h(this, R).getInt16(h(this, w), h(this, te));
		return x$2(this, w, h(this, w) + 2), t;
	}
	byte() {
		let t = h(this, R).getUint8(h(this, w));
		return U$1(this, w)._++, t;
	}
	int32() {
		let t = h(this, R).getInt32(h(this, w), h(this, te));
		return x$2(this, w, h(this, w) + 4), t;
	}
	string(t) {
		return h(this, le$1).decode(this.bytes(t));
	}
	cstring() {
		let t = h(this, w), n = t;
		for (; h(this, R).getUint8(n++) !== 0;);
		let s = this.string(n - t - 1);
		return x$2(this, w, n), s;
	}
	bytes(t) {
		let n = h(this, R).buffer.slice(h(this, w), h(this, w) + t);
...
var pe$1 = class {
	...
	parse(t, n) {
		T$1(this, c, et$1).call(this, ArrayBuffer.isView(t) ? t.buffer.slice(t.byteOffset, t.byteOffset + t.byteLength) : t);
		let s = h(this, D$1) + h(this, B), i = h(this, D$1);
		for (; i + Xe$1 <= s;) {
			let a = h(this, A).getUint8(i), u = h(this, A).getUint32(i + Le, !1), m = Le + u;
			if (m + i <= s && u > 0) {
				let l;
				try {
					l = T$1(this, c, tt$1).call(this, i + Xe$1, a, u, h(this, A).buffer);
				} catch (E) {
					throw T$1(this, c, ke).call(this), E;
				}
				n(l), i += m;
			} else break;
		}
		i === s ? T$1(this, c, ke).call(this) : (x$2(this, B, s - i), x$2(this, D$1, i));
	}
};
A = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), D$1 = /* @__PURE__ */ new WeakMap(), o$1 = /* @__PURE__ */ new WeakMap(), c = /* @__PURE__ */ new WeakSet(), ke = function() {
	x$2(this, A, new DataView(Ze$1)), x$2(this, B, 0), x$2(this, D$1, 0);
}, et$1 = function(t) {
	if (h(this, B) > 0) {
		let n = h(this, B) + t.byteLength;
		if (n + h(this, D$1) > h(this, A).byteLength) {
			let i;
			if (n <= h(this, A).byteLength && h(this, D$1) >= h(this, B)) i = h(this, A).buffer;
			else {
				let a = h(this, A).byteLength * 2;
				for (; n >= a;) a *= 2;
				i = new ArrayBuffer(a);
			}
			new Uint8Array(i).set(new Uint8Array(h(this, A).buffer, h(this, D$1), h(this, B))), x$2(this, A, new DataView(i)), x$2(this, D$1, 0);
		}
		new Uint8Array(h(this, A).buffer).set(new Uint8Array(t), h(this, D$1) + h(this, B)), x$2(this, B, n);
	} else x$2(this, A, new DataView(t)), x$2(this, D$1, 0), x$2(this, B, t.byteLength);
	...
	switch (n) {
		...
		case 87: return Re$1;
		case 73: return Ee$1;
		case 68: return T$1(this, c, pt).call(this, t, s, i);
		case 67: return T$1(this, c, rt$1).call(this, t, s, i);
		case 90: return T$1(this, c, nt).call(this, t, s, i);
		case 65: return T$1(this, c, ot$1).call(this, t, s, i);
		case 82: return T$1(this, c, mt).call(this, t, s, i);
		case 83: return T$1(this, c, dt).call(this, t, s, i);
		case 75: return T$1(this, c, ft$1).call(this, t, s, i);
		case 69: return T$1(this, c, Ue$1).call(this, t, s, i, "error");
		case 78: return T$1(this, c, Ue$1).call(this, t, s, i, "notice");
		case 84: return T$1(this, c, ut).call(this, t, s, i);
		case 116: return T$1(this, c, lt).call(this, t, s, i);
		case 71: return T$1(this, c, it).call(this, t, s, i);
		case 72: return T$1(this, c, at$1).call(this, t, s, i);
		case 100: return T$1(this, c, st$1).call(this, t, s, i);
		default: return new N$1("received invalid response: " + n.toString(16), s, "error");
	}
}, nt = function(t, n, s) {
	h(this, o$1).setBuffer(t, s);
	return new $$1(n, h(this, o$1).string(1));
}, rt$1 = function(t, n, s) {
	h(this, o$1).setBuffer(t, s);
	return new X(n, h(this, o$1).cstring());
}, st$1 = function(t, n, s) {
	let i = s.slice(t, t + (n - 4));
	return new H$1(n, new Uint8Array(i));
}, it = function(t, n, s) {
	return T$1(this, c, Oe).call(this, t, n, s, "copyInResponse");
}, at$1 = function(t, n, s) {
	return T$1(this, c, Oe).call(this, t, n, s, "copyOutResponse");
}, Oe = function(t, n, s, i) {
	h(this, o$1).setBuffer(t, s);
	let a = h(this, o$1).byte() !== 0, u = h(this, o$1).int16(), m = new z$2(n, i, a, u);
	for (let l = 0; l < u; l++) m.columnTypes[l] = h(this, o$1).int16();
	return m;
}, ot$1 = function(t, n, s) {
	h(this, o$1).setBuffer(t, s);
	...
	h(this, o$1).setBuffer(t, s);
	let i = h(this, o$1).int16(), a = new Y(n, i);
	for (let u = 0; u < i; u++) a.fields[u] = T$1(this, c, ct).call(this);
	return a;
}, ct = function() {
	return new q(h(this, o$1).cstring(), h(this, o$1).int32(), h(this, o$1).int16(), h(this, o$1).int32(), h(this, o$1).int16(), h(this, o$1).int32(), h(this, o$1).int16() === 0 ? Pe$1.text : Pe$1.binary);
}, lt = function(t, n, s) {
	h(this, o$1).setBuffer(t, s);
	let i = h(this, o$1).int16(), a = new j(n, i);
	...
	for (let u = 0; u < i; u++) {
		let m = h(this, o$1).int32();
		a[u] = m === -1 ? null : h(this, o$1).string(m);
	}
	return new Z(n, a);
}, dt = function(t, n, s) {
	h(this, o$1).setBuffer(t, s);
	return new W$1(n, h(this, o$1).cstring(), h(this, o$1).cstring());
}, ft$1 = function(t, n, s) {
	h(this, o$1).setBuffer(t, s);
	return new K(n, h(this, o$1).int32(), h(this, o$1).int32());
}, mt = function(t, n, s) {
	h(this, o$1).setBuffer(t, s);
	...
	switch (i) {
		...
		case 5: return new G$1(n, h(this, o$1).bytes(4));
		case 10: {
			let a = [];
			for (;;) {
		...
		case 11: return new _$1(n, h(this, o$1).string(n - 8));
		case 12: return new v$1(n, h(this, o$1).string(n - 8));
...
var z$1 = class {
	...
	async query(s, e, r) {
		return await this._checkReady(), await this._runExclusiveTransaction(async () => await T$1(this, t, x$1).call(this, s, e, r));
	}
	async sql(s, ...e) {
	...
	async exec(s, e) {
		return await this._checkReady(), await this._runExclusiveTransaction(async () => await T$1(this, t, m).call(this, s, e));
	}
	async describeQuery(s, e) {
		let r = [];
		try {
			await T$1(this, t, y).call(this, $e$1.parse({
				text: s,
				types: e?.paramTypes
			}), e), r = await T$1(this, t, y).call(this, $e$1.describe({ type: "S" }), e);
		} catch (n) {
			...
			r.push(...await T$1(this, t, y).call(this, $e$1.sync(), e));
		}
	...
	async transaction(s) {
		return await this._checkReady(), await this._runExclusiveTransaction(async () => {
			await T$1(this, t, m).call(this, "BEGIN"), x$2(this, p, !0);
			let e = !1, r = () => {
				if (e) throw new Error("Transaction is closed");
			}, o = {
				query: async (i, c, u) => (r(), await T$1(this, t, x$1).call(this, i, c, u)),
				sql: async (i, ...c) => {
					r();
					let { query: u, params: n } = g(i, ...c);
					return await T$1(this, t, x$1).call(this, u, n);
				},
				exec: async (i, c) => (r(), await T$1(this, t, m).call(this, i, c)),
				rollback: async () => {
					r(), await T$1(this, t, m).call(this, "ROLLBACK"), e = !0;
				},
			...
			try {
				let i = await s(o);
				return e || (e = !0, await T$1(this, t, m).call(this, "COMMIT")), x$2(this, p, !1), i;
			} catch (i) {
				throw e || (e = !0, await T$1(this, t, m).call(this, "ROLLBACK")), x$2(this, p, !1), i;
			}
		});
	}
...
P = /* @__PURE__ */ new WeakMap(), p = /* @__PURE__ */ new WeakMap(), t = /* @__PURE__ */ new WeakSet(), y = async function(s, e = {}) {
	...
	return await this._runExclusiveQuery(async () => {
		T$1(this, t, _).call(this, "runQuery", s, e, r), await this._handleBlob(r?.blob);
		let o = [];
		try {
			let c = await T$1(this, t, y).call(this, $e$1.parse({
				text: s,
				types: r?.paramTypes
			}), r), u = bn(await T$1(this, t, y).call(this, $e$1.describe({ type: "S" }), r)), n = e.map((b, k) => {
				let D = u[k];
			...
			o = [
				...c,
				...await T$1(this, t, y).call(this, $e$1.bind({ values: n }), r),
				...await T$1(this, t, y).call(this, $e$1.describe({ type: "P" }), r),
				...await T$1(this, t, y).call(this, $e$1.execute({}), r)
			];
		} catch (c) {
			...
			o.push(...await T$1(this, t, y).call(this, $e$1.sync(), r));
		}
	...
	return await this._runExclusiveQuery(async () => {
		T$1(this, t, _).call(this, "runExec", s, e), await this._handleBlob(e?.blob);
		let r = [];
		try {
			r = await T$1(this, t, y).call(this, $e$1.query(s), e);
		} catch (i) {
...
async function Re(e) {
	if (p$1.IN_NODE) {
		let t = await import("./browser-external_fs-Dk1dP2xu.js").then((n) => /* @__PURE__ */ __toESM(n.t(), 1)), r = await import("./browser-external_zlib-DIiORg6j.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), { Writable: a } = await import("./browser-external_stream-CwWDFrBs.js").then((n) => /* @__PURE__ */ __toESM(n.t(), 1)), { pipeline: o } = await import("./promises-DbwB8AUf.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	...
	async init(t, r) {
		return this.pg = t, { emscriptenOpts: {
			...
			preRun: [...r.preRun || [], (o) => {
				...
				o.FS.analyzePath("/pglite").exists || o.FS.mkdir("/pglite"), o.FS.analyzePath(`/pglite/${this.dataDir}`).exists || o.FS.mkdir(`/pglite/${this.dataDir}`), o.FS.mount(_, {}, `${I$1}/${this.dataDir}`), o.FS.symlink(`${I$1}/${this.dataDir}`, B$1);
			}]
		} };
	}
	initialSyncFs() {
...
async function je(e, t) {
	let r;
	if (e && t === "nodefs") {
		let { NodeFS: a } = await import("./nodefs-BNQcPJcy.js");
		r = new a(e);
	} else if (e && t === "idbfs") r = new ve(e);
	else if (e && t === "opfs-ahp") {
		let { OpfsAhpFS: a } = await import("./opfs-ahp-CtRyOCbx.js");
		r = new a(e);
	} else r = new Ee();
	return r;
}
...
var ht = (() => {
	...
	return async function(moduleArg = {}) {
		...
		if (ENVIRONMENT_IS_NODE) {
			let { createRequire: e } = await import("./browser-external_module-Blgvmq7y.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), t = import.meta.url;
			t.startsWith("data:") && (t = "/");
			var require = e(t);
		}
		...
		function findWasmBinary() {
			...
			return new URL("../../@electric-sql/pglite/dist/pglite.wasm", import.meta.url).href;
		}
		var wasmBinaryFile;
...
`));
			...
			FSNode: class {
				constructor(e, t, r, a) {
					P$2(this, "node_ops", {});
					P$2(this, "stream_ops", {});
					P$2(this, "readMode", 365);
					P$2(this, "writeMode", 146);
					P$2(this, "mounted", null);
...
var N = class N extends z$1 {
	constructor(r = {}, a = {}) {
		...
		typeof r == "string" ? a = {
			...
			...this.serializers,
			...a.serializers
		}), a?.debug !== void 0 && (this.debug = a.debug), a?.relaxedDurability !== void 0 && x$2(this, ie, a.relaxedDurability), x$2(this, ue, a.extensions ?? {}), this.waitReady = T$1(this, x, Ye).call(this, a ?? {});
	}
	get ENV() {
		return this.mod?.ENV;
	}
	...
	get ready() {
		return h(this, oe) && !h(this, _e) && !h(this, se);
	}
	get closed() {
		return h(this, se);
	}
	async close() {
		...
		for (let r of h(this, Me)) await r();
		try {
			this.mod._pgl_setPGliteActive(0), await this.execProtocol($e$1.end()), this.mod._pgl_run_atexit_funcs();
		} catch (r) {
			let a = r;
			a.name === "ExitStatus" && a.status === 0 || T$1(this, x, G).call(this, "An error occured while closing the db", r.toString());
		} finally {
			this.mod.removeFunction(h(this, me)), this.mod.removeFunction(h(this, ce));
		}
		await this.fs.closeFs(), x$2(this, se, !0), x$2(this, _e, !1), x$2(this, oe, !1), x$2(this, ge, !1);
		try {
			this.mod._emscripten_force_exit(0);
		} catch (r) {
			T$1(this, x, G).call(this, r), r.status !== 0 && T$1(this, x, G).call(this, "Error when exiting", r.toString());
		} finally {
			this.mod = void 0;
		}
	}
	...
	async _getWrittenBlob() {
		if (!h(this, ee)) return;
		let r = new Blob(h(this, ee));
		return x$2(this, ee, void 0), r;
	}
	async _checkReady() {
		if (h(this, _e)) throw new Error("PGlite is closing");
		if (h(this, se)) throw new Error("PGlite is closed");
		h(this, oe) || await this.waitReady;
	}
	execProtocolRawSync(r) {
		let a = this.mod;
		if (x$2(this, W, 0), x$2(this, z, 0), x$2(this, $, r), h(this, H) || x$2(this, H, T$1(this, x, et)), h(this, O).length !== N.DEFAULT_RECV_BUF_SIZE && x$2(this, O, new Uint8Array(N.DEFAULT_RECV_BUF_SIZE)), r[0] === 88) return /* @__PURE__ */ new Uint8Array(0);
		if (r[0] === 0) return T$1(this, x, st).call(this, r);
		try {
			for (; h(this, W) < r.length || a._pq_buffer_remaining_data() > 0;) try {
		...
		return x$2(this, $, []), h(this, z) ? new Uint8Array(h(this, O).subarray(0, h(this, z))) : /* @__PURE__ */ new Uint8Array(0);
	}
	...
	async execProtocolRawStream(r, { syncToFs: a = !0, onRawData: o }) {
		x$2(this, H, (_) => (o(_), _.length)), this.execProtocolRawSync(r), a && await this.syncToFs();
	}
	async execProtocol(r, { syncToFs: a = !0, throwOnError: o = !0, onNotice: _ } = {}) {
		...
		let s = await this.execProtocolRaw(r, { syncToFs: a }), n = h(this, I).databaseError, l = {
			messages: h(this, I).results,
			data: s
		};
		if (x$2(this, I, new ae()), x$2(this, H, void 0), o && n) throw x$2(this, pe, new pe$1()), n;
		return l;
	}
	async execProtocolStream(r, { syncToFs: a, throwOnError: o = !0, onNotice: _ } = {}) {
		x$2(this, I, new ae({
			throwOnError: o,
			onNotice: _
		})), x$2(this, H, T$1(this, x, qe)), await this.execProtocolRaw(r, { syncToFs: a });
		let s = h(this, I).databaseError, n = h(this, I).results;
		if (x$2(this, I, new ae()), x$2(this, H, void 0), o && s) throw x$2(this, pe, new pe$1()), s;
		return n;
	}
	isInTransaction() {
	...
	async syncToFs() {
		...
		x$2(this, de, !0);
		let r = async () => {
			await h(this, Ce).runExclusive(async () => {
				x$2(this, de, !1), await this.fs.syncToFs(h(this, ie));
			});
		};
		h(this, ie) ? r() : await r();
	}
	async listen(r, a, o) {
		return this._runExclusiveListen(() => T$1(this, x, rt).call(this, r, a, o));
	}
	async unlisten(r, a, o) {
		return this._runExclusiveListen(() => T$1(this, x, at).call(this, r, a, o));
	}
	onNotification(r) {
		return h(this, le).add(r), () => {
			h(this, le).delete(r);
		};
	}
	offNotification(r) {
	...
	_runExclusiveQuery(r) {
		return h(this, Fe).runExclusive(r);
	}
	_runExclusiveTransaction(r) {
		return h(this, Te$1).runExclusive(r);
	}
	async clone() {
		let r = await this.dumpDataDir("none");
		return N.create({
			loadDataDir: r,
			extensions: h(this, ue)
		});
	}
	_runExclusiveListen(r) {
		return h(this, Pe).runExclusive(r);
	}
	callMain(r) {
...
H = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), se = /* @__PURE__ */ new WeakMap(), ie = /* @__PURE__ */ new WeakMap(), Fe = /* @__PURE__ */ new WeakMap(), Te$1 = /* @__PURE__ */ new WeakMap(), Pe = /* @__PURE__ */ new WeakMap(), Ce = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakMap(), ue = /* @__PURE__ */ new WeakMap(), Me = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap(), ne = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), le = /* @__PURE__ */ new WeakMap(), ce = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), me = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ new WeakMap(), O = /* @__PURE__ */ new WeakMap(), z = /* @__PURE__ */ new WeakMap(), he = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap(), ge = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakSet(), Xe = function(r) {
	...
	r.pgliteWasmModule || p$1.startArtifactDownload(new URL("../../@electric-sql/pglite/dist/pglite.wasm", import.meta.url)), r.initdbWasmModule || p$1.startArtifactDownload(new URL("../../@electric-sql/pglite/dist/initdb.wasm", import.meta.url));
	let s = new URL("../../@electric-sql/pglite/dist/pglite.data", import.meta.url), n = r.fsBundle ? r.fsBundle.arrayBuffer() : p$1.getFsBundle(s), l;
	n.then((u) => {
		l = u;
	});
	let d = new WebAssembly.Memory({
		...
		thisProgram: wt$2,
		PGLITE_ENV: {},
		WASM_PREFIX: p$1.WASM_PREFIX,
		arguments: _,
		noExitRuntime: !0,
		wasmMemory: d,
		stdin: () => null,
		print: (u) => {
			T$1(this, x, Xe).call(this, u);
		},
		printErr: (u) => {
			T$1(this, x, Ke).call(this, u);
		},
		instantiateWasm: (u, f) => {
			let c = new URL("../../@electric-sql/pglite/dist/pglite.wasm", import.meta.url);
			return p$1.instantiateWasm(u, c, r.pgliteWasmModule).then(({ instance: w, module: S }) => {
				f(w, S);
			}), {};
		},
		...
		preRun: [
			...
			(u) => {
				...
				u.FS.registerDevice(f, {
					...
					write: (w, S, k, E, y) => (h(this, ee) ?? x$2(this, ee, []), h(this, ee).push(S.slice(k, k + E)), E),
					llseek: (w, S, k) => {
						let E = h(this, ne);
	...
	p = m;
	let g = [];
	for (let [u, f] of Object.entries(h(this, ue))) if (f instanceof URL) a[u] = Re(f);
	else {
		...
		c.bundlePath && (a[u] = Re(c.bundlePath)), c.init && o.push(c.init), c.close && h(this, Me).push(c.close), g.push(...c.sharedPreloadLibraries ?? []);
	}
	if (p.pg_extensions = a, await n, this.mod = await We(p), await this.fs.initialSyncFs(), r.icuDataDir && await T$1(this, x, $e).call(this, r.icuDataDir), !r.noInitDb) {
		if (r.loadDataDir) {
			...
			T$1(this, x, G).call(this, "pglite: loading data from tarball"), await at$2(this.mod.FS, r.loadDataDir, B$1);
		} else if (this.mod.FS.analyzePath("/pglite/data/PG_VERSION").exists) T$1(this, x, G).call(this, "pglite: found DB, resuming");
		else {
			T$1(this, x, G).call(this, "pglite: no db in filesystem, running initdb");
			let u = { ...r };
		...
		await Ue(this.mod, (...u) => T$1(this, x, G).call(this, ...u)), T$1(this, x, Qe).call(this, g, r), this.mod._pgl_setPGliteActive(1), T$1(this, x, _t).call(this, {
			pgDataFolder: B$1,
			startParams: [...r.startParams || N.defaultStartParams, ...this.debug ? ["-d", this.debug.toString()] : []]
		}), T$1(this, x, ot).call(this), x$2(this, oe, !0), r.username && await this.exec(`SET ROLE ${r.username};`), await this._initArrayTypes();
...
shared_preload_libraries=${r.join(",")}`;
	...
	T$1(this, x, G).call(this, `pglite: icuDataDir specified, removing default icu data dir at ${jr}`), p$1.rmdirRecursive(this.mod.FS, jr), T$1(this, x, G).call(this, `pglite: loading icu data from tarball ${r}`), this.mod.FS.mkdirTree(jr), await at$2(this.mod.FS, r, jr);
}, Je = function(r) {
	x$2(this, he, r.addFunction((a) => (T$1(this, x, G).call(this, `Postgres tried to execute ${r.UTF8ToString(a)}, returning 1.`), 1), "pi")), r._pgl_set_system_fn(h(this, he)), x$2(this, xe, r.addFunction((a, o) => {
	...
	}, "ppp")), r._pgl_set_popen_fn(h(this, xe)), x$2(this, we, r.addFunction((a) => {
		...
		T$1(this, x, G).call(this, "pclose_fn", a);
	}, "pi")), r._pgl_set_pclose_fn(h(this, we)), x$2(this, ce, r.addFunction((a, o) => {
		let _;
		try {
		...
		return h(this, H).call(this, _);
	}, "iii")), x$2(this, me, r.addFunction((a, o) => {
		let _ = h(this, $).length - h(this, W);
		return _ > o && (_ = o), this.mod.HEAP8.set(h(this, $).subarray(h(this, W), h(this, W) + _), a), x$2(this, W, h(this, W) + _), _;
	}, "iii")), r._pgl_set_rw_cbs(h(this, me), h(this, ce));
}, et = function(r) {
	let a = r.slice(), o = h(this, z) + a.length;
	if (o > h(this, O).length) {
		let _ = h(this, O).length + (h(this, O).length >> 1) + o;
		o > N.MAX_BUFFER_SIZE && (o = N.MAX_BUFFER_SIZE);
		let s = new Uint8Array(_);
		s.set(h(this, O).subarray(0, h(this, z))), x$2(this, O, s);
	}
	return h(this, O).set(a, h(this, z)), x$2(this, z, h(this, z) + a.length), T$1(this, x, qe).call(this, a);
}, qe = function(r) {
	return h(this, pe).parse(r, (a) => {
		let o = T$1(this, x, tt).call(this, a);
		o && h(this, I).results.push(o);
	}), r.length;
}, tt = function(r) {
	if (!h(this, I).databaseError) {
		if (r instanceof N$1) h(this, I).throwOnError && (h(this, I).databaseError = r);
		else if (r instanceof ee$1) this.debug > 0 && console.warn(r), h(this, I).onNotice && h(this, I).onNotice(r);
		else if (r instanceof J$1) {
			let a = h(this, D).get(r.channel);
			a && a.forEach((o) => {
	...
	let _ = p$1.toPostgresName(r), s = o ?? this;
	h(this, D).has(_) || h(this, D).set(_, /* @__PURE__ */ new Set()), h(this, D).get(_).add(a);
	try {
		await s.exec(`LISTEN ${r}`);
	} catch (n) {
		throw h(this, D).get(_).delete(a), h(this, D).get(_)?.size === 0 && h(this, D).delete(_), n;
	}
	return async (n) => {
		await this.unlisten(_, a, n);
	};
}, at = async function(r, a, o) {
	let _ = p$1.toPostgresName(r), s = o ?? this, n = async () => {
		await s.exec(`UNLISTEN ${r}`), h(this, D).get(_)?.size === 0 && h(this, D).delete(_);
	};
	a ? (h(this, D).get(_)?.delete(a), h(this, D).get(_)?.size === 0 && await n()) : await n();
}, ot = function() {
	if (h(this, ge)) throw new Error("PGlite single mode already running");
	...
	x$2(this, W, 0), x$2(this, z, 0), x$2(this, $, r);
	...
	return this.mod._pgl_sendConnData(), this.mod._pgl_pq_flush(), x$2(this, $, []), h(this, z) ? h(this, O).subarray(0, h(this, z)) : /* @__PURE__ */ new Uint8Array(0);
}, N.paths = {
	PG_ROOT: I$1,
	PGDATA: B$1,
	ICU_DATA_PATH: jr,
...
u();
//#endregion
export { ve as IdbFs, Ee as MemoryFS, J as Mutex, Ve as PGlite, v as formatQuery, Te as messages, gn as parse, zn as protocol, yn as types };
