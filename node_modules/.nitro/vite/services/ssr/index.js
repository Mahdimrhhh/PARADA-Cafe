...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Cfr1CkHZ.js");
...
var manifest = {
	"387c18e0906cee8a641455d8cf1d60462744d3c41e01f7289e9ade232d8258ae": {
		...
		importer: () => import("./assets/menu-D9qbu5VX.js")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-BMRQ4yFz.js").then((n) => n.t),
