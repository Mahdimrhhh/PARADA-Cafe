...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CnGrn8qv.js");
...
var manifest = {
	"387c18e0906cee8a641455d8cf1d60462744d3c41e01f7289e9ade232d8258ae": {
		...
		importer: () => import("./assets/menu-CoStXPts.js")
	},
	...
	"e1e75eeb5b828a5e72df16b5ebc0ac6dd7bf5b66ea17652e2bb587b680f6c8fb": {
		functionName: "uploadImage_createServerFn_handler",
		importer: () => import("./assets/upload-BXaqEgSW.js")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-sscEgE-1.js").then((n) => n.t),
