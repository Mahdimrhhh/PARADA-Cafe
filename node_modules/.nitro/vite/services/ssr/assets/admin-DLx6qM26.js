import { c as updatePin, i as deleteItem, l as updateSettings, n as createItem, o as updateCategory, r as deleteCategory, s as updateItem, t as createCategory, u as verifyPin } from "./menu-oz6FXPGl.js";
import { n as Route } from "./router-Coh3AXib.js";
import { a as cn, i as ICON_KEYS, n as Button, r as CategoryIcon, t as formatToman } from "./format-DqAqKtxT.js";
		...
		children: [/* @__PURE__ */ jsxs("header", {
			...
			children: [
				tab === "items" && category ? /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("section", { children: [
						/* @__PURE__ */ jsx("div", {
							...
							children: menu.categories.map((row) => /* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(CategoryIcon, {
									name: row.iconKey,
									className: "size-5"
								}), row.nameFa]
							}, row.id))
						...
						/* @__PURE__ */ jsx("ul", {
							...
							children: category.items.map((item) => /* @__PURE__ */ jsxs("li", {
					...
					] }), editing || creating ? /* @__PURE__ */ jsx(ItemEditor, {
						item: editing,
				...
				tab === "categories" ? /* @__PURE__ */ jsx(CategoriesEditor, {
					menu,
					onMenu
				}) : null,
				tab === "settings" ? /* @__PURE__ */ jsx(SettingsEditor, {
					menu,
					onMenu
				}) : null
			]
				...
				children: [
					...
					/* @__PURE__ */ jsx(Field, {
						...
						children: /* @__PURE__ */ jsx("select", {
							...
							children: categories.map((row) => /* @__PURE__ */ jsx("option", {
								value: row.id,
								children: row.nameFa
							}, row.id))
						})
					...
					/* @__PURE__ */ jsxs(Field, {
						...
						}), form.imageUrl ? /* @__PURE__ */ jsxs("div", {
...
function CategoriesEditor({ menu, onMenu }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "space-y-4",
		children: [menu.categories.map((category) => /* @__PURE__ */ jsx(CategoryRow, {
			category,
			onMenu
		}, category.id)), /* @__PURE__ */ jsxs("form", {
			onSubmit: add,
					...
					children: [
						...
						/* @__PURE__ */ jsx(Field, {
							...
							children: /* @__PURE__ */ jsx("select", {
								...
								children: ICON_KEYS.map((key) => /* @__PURE__ */ jsx("option", {
									value: key,
									children: key
								}, key))
							})
